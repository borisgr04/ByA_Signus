<%@ Page Title="" Language="C#" MasterPageFile="~/SiteBS.Master" AutoEventWireup="true" CodeBehind="CancelarPago.aspx.cs" Inherits="webSignusL.Estampillas.Pagos.CancelarPago" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row" style="margin-bottom:10px">
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <button type="button" value="Nuevo" id="btnCancelarPago" class="btn btn-success habilitarcancelar" style="margin-top:24px" title="Registrar Nueva Solicitud de Contratación.">
                                            <span class="glyphicon glyphicon-save"></span>Cancelar pago
                                        </button>
                                    </div>  
                                    <div class="col-xs-4">
                                        <div id="secInfo"></div>
    ...
    <script type="text/javascript" src="js/CancelarPago.js"></script>
