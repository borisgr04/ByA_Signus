var objgestion = (function () {
    ...
    var _createElements = function () {
        ...
        $("#info").html("Liquidaciones <strong>pagadas</strong> del mes de " + byaPage.returnNombreMes(Periodo));
        _traerLiquidaciones();
    };
    var _traerLiquidaciones = function () {
        SL_LIQESTAMPILLAS_DAO.GetsPagadas(Periodo, Vigencia, Agente, function (result) {
